...
Ext.define('Jhako.controller.process.JobunitTab', {
  ...
  onLoadJobunit: function(record) {
    ...
    var me = this;
    Jhako.model.ProcJobunit.load(record.data.id, {
  ...
  onLoadJobunitDetail: function(record) {
    ...
    var ctrl_execlog = Jhako.app.getController('common.Execlog');
    var ctrl_variable = Jhako.app.getController('common.Variable');
    var ctrl_sidebar = Jhako.app.getController('process.Sidebar');

    ctrl_jobresult.onLoadProcRecord(record);
    ctrl_execlog.onLoadProcRecord(record);
    ctrl_variable.onLoadProcRecord(record);
    ctrl_sidebar.onResetButton(record);
